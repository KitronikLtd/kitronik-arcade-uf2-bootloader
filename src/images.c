...
//{32, 32, 17, 191, 191, 191, 191, 191, 191, 191, 191, 191, 191, 191, 191, 191, 191, 191, 191, 144 };
...
const uint8_t KitronikLogo[] = {
32, 32, 72, 191, 120, 216, 112, 217, 112, 217, 112, 217, 112, 217, 144, 31, 152, 31, 152, 63, 151, 202, 149, 204, 146, 208, 142, 212, 139, 201, 120, 199, 136, 200, 64, 203, 96, 63, 136, 203, 112, 7, 137, 201, 112, 3, 139, 199, 112, 1, 141, 31, 155, 7, 154, 3, 191, 159, 31, 124, 207, 120, 97, 210, 120, 97, 210, 120, 97, 210, 120, 97, 210, 191, 0
}; 

const uint8_t LargeFive[] = {16, 16, 18, 176, 200, 64, 201, 64, 7, 3, 30, 12, 120, 112, 112, 3, 200, 6, 124, 191, 164};

const uint8_t LargeOne[] = {16, 16, 10, 162, 3, 64, 126, 217, 143, 1, 191, 191, 156};

const uint8_t LargeD[] = {16, 16, 20, 2, 136, 125, 202, 126, 201, 6, 135, 27, 137, 27, 136, 103, 136, 7, 203, 64, 200, 191, 180};
