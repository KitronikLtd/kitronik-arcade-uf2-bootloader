...
#define VENDOR_NAME "Kitronik Ltd"
#define PRODUCT_NAME "ARCADE"
#define VOLUME_LABEL "KIT-ARCD"
#define INDEX_URL "https://arcade.makecode.com/"
#define BOARD_ID "SAMD51J19A-Kitronik-Arcade-D51"

#define USB_VID 0x04D8
#define USB_PID 0XED7A

#define LED_PIN PIN_PB30  //was PA22
...
//THe list of magic numbers is in configkeys.h in the inc directory

#ifdef DEFINE_CONFIG_DATA
const uint32_t config_data[] = {
    /* CF2 START */
    513675505, 539130489, // magic
    64, 103,  // used entries, total entries
    4, 0x17, // PIN_BTN_A = PA_23
    ...
    44, 0x6, // PIN_DISPLAY_BL = PIN_A6
    47, 0x16, // PIN_BTN_LEFT = PIN_D12
    48, 0x31, // PIN_BTN_RIGHT = PB_17
    49, 0x14, // PIN_BTN_UP = PIN_D10
    50, 0x15, // PIN_BTN_DOWN = PIN_D11
    51, 0x30, // PIN_BTN_MENU = PB_16
    59, 0xFF, // SPEAKER_VOLUME =  IS this 8 bit? Set to FF to try was 0x200
    60, 0x11, // PIN_JACK_TX = PIN_D1
    65, 0x3, // PIN_JACK_SND = PA02
    76, 0x5, //CFG_PIN_VIBRATION = PIN_A1
    77, 0x3E, // CFG_PIN_JACK_PWREN = PB15
    100, 0x2, // PIN_A0 = PA02
    101, 0x5, // PIN_A1 = PA05
